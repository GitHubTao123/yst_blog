...
public class CommentController {
    ...
    public int countComment(@PathParam("arti_id") int arti_id){
        return restTemplate.getForObject("http://comment-provider/countComment?arti_id="+arti_id,int.class);
    }
    ...
    public List<Map<String,Object>> getCommentByArtiId(@PathParam("arti_id") int arti_id){
        List<Map<String,Object>> lists = restTemplate.getForObject("http://comment-provider/getCommentByArtiId?arti_id=" + arti_id, List.class);
        return lists;
    }
